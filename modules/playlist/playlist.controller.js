...
exports.getParticularData = async function (req, res, next) {
    ...
    try {
        ...
        let nonNumericFields = Object.keys(PLAYLIST.schema.paths).filter(field => field !== "_id" && (PLAYLIST.schema.paths[field].instance !== 'Number'));
...
exports.update = async function (req, res, next) {
    ...
    try {
        let Data = await PLAYLIST.findByIdAndUpdate(req.params.id, req.body, {new: true})
        if(!Data)
        {
            throw new Error('Data Was Not Found')
        }
