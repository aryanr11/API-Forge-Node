...
exports.getParticularData = async function (req, res, next) {
    ...
    try {
        ...
        let nonNumericFields = Object.keys(HOTEL.schema.paths).filter(field => field !== "_id" && (HOTEL.schema.paths[field].instance !== 'Number'));
...
exports.update = async function (req, res, next) {
    ...
    try {
        let Data = await HOTEL.findByIdAndUpdate(req.params.id, req.body, {new: true})
        if(!Data)
        {
            throw new Error('Data Was Not Found')
        }
