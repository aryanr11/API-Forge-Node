...
exports.getParticularData = async function (req, res, next) {
    ...
    try {
        ...
        let nonNumericFields = Object.keys(HOSPITAL.schema.paths).filter(field => field !== "_id" && (HOSPITAL.schema.paths[field].instance !== 'Number'));
...
exports.update = async function (req, res, next) {
    ...
    try {
        let Data = await HOSPITAL.findByIdAndUpdate(req.params.id, req.body, {new: true})
        if(!Data)
        {
            throw new Error('Data Was Not Found')
        }
