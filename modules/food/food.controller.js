...
exports.getParticularData = async function (req, res, next) {
    ...
    try {
        ...
        let nonNumericFields = Object.keys(FOOD.schema.paths).filter(field => field !== "_id" && (FOOD.schema.paths[field].instance !== 'Number'));
...
exports.update = async function (req, res, next) {
    ...
    try {
        let Data = await FOOD.findByIdAndUpdate(req.params.id, req.body, {new: true})
        if(!Data)
        {
            throw new Error('Data Was Not Found')
        }
