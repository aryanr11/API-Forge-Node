...
exports.getParticularData = async function (req, res, next) {
    ...
    try {
        ...
        let nonNumericFields = Object.keys(GST.schema.paths).filter(field => field !== "_id" && (GST.schema.paths[field].instance !== 'Number'));
...
exports.update = async function (req, res, next) {
    ...
    try {
        let Data = await GST.findByIdAndUpdate(req.params.id, req.body, {new: true})
        if(!Data)
        {
            throw new Error('Data Was Not Found')
        }
